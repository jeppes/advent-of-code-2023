...
let day_20 _ =
  ...
  let day_20 = Util.read_file "inputs/day20.txt" in
  let day_20_part_1 = Util.measure_ns Day_20.solve_1 day_20 in
  print_endline ("Part 1 " ^ Util.to_result ~result:day_20_part_1 ~expected:806332748)
;;

let day_21 _ =
  print_endline "Day 21";
  let day_21 = Util.read_file "inputs/day21.txt" in
  let day_21_part_1 = Util.measure_ns Day_21.solve_1 day_21 in
  print_endline ("Part 1 " ^ Util.to_result ~result:day_21_part_1 ~expected:3600)
;;

let day_22 _ =
  print_endline "Day 22";
  let day_22 = Util.read_file "inputs/day22.txt" in
  let day_22_part_1 = Util.measure_ns Day_22.solve_1 day_22 in
  print_endline ("Part 1 " ^ Util.to_result ~result:day_22_part_1 ~expected:389);
  let day_22_part_2 = Util.measure_ns Day_22.solve_2 day_22 in
  print_endline ("Part 2 " ^ Util.to_result ~result:day_22_part_2 ~expected:70609)
;;

let day_23 _ =
  print_endline "Day 23";
  let day_23 = Util.read_file "inputs/day23.txt" in
  let day_23_part_1 = Util.measure_ns Day_23.solve_1 day_23 in
  print_endline ("Part 1 " ^ Util.to_result ~result:day_23_part_1 ~expected:2414);
  let day_23_part_2 = Util.measure_ns Day_23.solve_2 day_23 in
  print_endline ("Part 2 " ^ Util.to_result ~result:day_23_part_2 ~expected:6598)
;;

let day_24 _ =
  print_endline "Day 24";
  let day_24 = Util.read_file "inputs/day24.txt" in
  let day_24_part_1 = Util.measure_ns Day_24.solve_1 day_24 in
  print_endline ("Part 1 " ^ Util.to_result ~result:day_24_part_1 ~expected:24627)
;;
